...
private:
    ...
    string _PrepareTransferRecord( clsBankClient DestinationClient,string UserName,float Amount, string Seperator = "#//#")
    {
    ...
    void _RegisterTransferLog(clsBankClient DestinationClient, float Amount, string UserName)
    {
        ...
        string stDataLine = _PrepareTransferRecord(DestinationClient, UserName, Amount);
